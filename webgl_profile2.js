...
async function run() {
  ...
  await page.evaluateOnNewDocument(() => {
    window.webglStats = {
      ...
      linkProgramCalls: 0,
      useProgramTime: 0,
      drawCalls: 0, drawTime: 0, getProgTime: 0,
      texImage2DTime: 0,
      texImage2DCalls: 0,
      frames: [],
      currentFrame: {
        ...
        useProgramTime: 0, drawCalls: 0, drawTime: 0, getProgTime: 0,
    ...
    function hookWebGL(proto) {
      ...
      const originalGetProg = proto.getProgramParameter;
      proto.getProgramParameter = function(...args) {
          const s = performance.now();
          const r = originalGetProg.apply(this, args);
          window.webglStats.currentFrame.getProgTime += (performance.now() - s);
          return r;
      };
      const originalGetShader = proto.getShaderParameter;
      proto.getShaderParameter = function(...args) {
          const s = performance.now();
          const r = originalGetShader.apply(this, args);
          window.webglStats.currentFrame.getProgTime += (performance.now() - s);
          return r;
      };
      ...
      proto.drawArrays = function(...args) {
        ...
        window.webglStats.currentFrame.drawTime += (performance.now() - s);
      };
